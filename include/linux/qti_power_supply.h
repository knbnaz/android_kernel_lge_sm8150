...
enum {
	...
	QTI_POWER_SUPPLY_PD_VPD_ACTIVE,
#endif
};
...
#ifdef CONFIG_LGE_USB
	QTI_POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_DEFAULT,		/* Rp default / Rp default */
	QTI_POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_DEFAULT_MEDIUM,	/* Rp default / Rp 1.5A */
	QTI_POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_DEFAULT_HIGH,		/* Rp default / Rp 3A */
	QTI_POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_MEDIUM,		/* Rp 1.5A / Rp 1.5A */
	QTI_POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_MEDIUM_HIGH,		/* Rp 1.5A / Rp 3A */
	QTI_POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_HIGH,			/* Rp 3A / Rp 3A */
#endif
