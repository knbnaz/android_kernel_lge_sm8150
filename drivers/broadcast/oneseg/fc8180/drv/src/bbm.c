...
#include "../inc/fc8180_bb.h"
#include "../inc/fc8180_isr.h"
...
s32 bbm_com_ts_callback_register(u32 userdata, s32 (*callback)(u32 userdata,
                        u8 *data, s32 length))
{
...
s32 bbm_com_ac_callback_register(u32 userdata, s32 (*callback)(u32 userdata,
                        u8 *data, s32 length))
{
