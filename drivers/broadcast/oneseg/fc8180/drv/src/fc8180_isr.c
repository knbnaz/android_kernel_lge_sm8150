...
s32 (*fc8180_ac_callback)(u32 userdata, u8 *data, s32 length) = NULL;
s32 (*fc8180_ts_callback)(u32 userdata, u8 *data, s32 length) = NULL;

u32 fc8180_ac_user_data;
u32 fc8180_ts_user_data;
